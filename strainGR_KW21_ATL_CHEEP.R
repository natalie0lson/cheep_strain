...
directory <- "Data/ATL_CHEEP_Strains/KW21"
...
fig_KW21 <- ggarrange(full_KW21,zoom_KW21,  cols=2)

#save the plots as image files
ggsave("figures/atl_KW21_fig.png", plot=fig_KW21, width =30, height = 30, units = "cm")

write.csv(combined_df, "atl_KW21.csv")

...
directory <- "Data/Comps/APEC102026"
...
#fig_APEC <- ggarrange(full_APEC,zoom_APEC,  cols=2)

#save the plots as image files
#ggsave("figures/APEC_fig.png", plot=fig_APEC, width =30, height = 30, units = "cm")

write.csv(combined_df, "APEC_2025-01-26.csv")
######################################################
...
write.csv(fig3, "APEC_2024-09-18.csv")
#!/bin/bash
#SBATCH --job-name="strain_gst_cheep"
#SBATCH --nodes=1
...
# MapSan Directories
output_dir="/projects/mnadimlab/nmolson/data/straingst/cheep"
dir="/projects/mnadimlab/nmolson/data/kmers/cheep_kmers"
cd /projects/mnadimlab/nmolson/data/kmers/cheep_kmers

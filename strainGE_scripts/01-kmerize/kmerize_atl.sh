...
cd /projects/mnadimlab/nmolson/data/atl_fastq

for f in /projects/mnadimlab/nmolson/data/atl_fastq/*.fastq.gz; do
    output_file="/projects/mnadimlab/nmolson/data/kmers/atl_kmers/kmerized$(basename ${f%.fastq.gz}.hdf5)"  # Define the output file path in the new directory

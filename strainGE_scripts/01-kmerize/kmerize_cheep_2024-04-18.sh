...
cd /projects/mnadimlab/mnadim/cheep/data/output/filter

for f in /projects/mnadimlab/mnadim/cheep/data/output/filter/*.fq.gz; do
    output_file="/projects/mnadimlab/nmolson/data/cheep_kmers/kmerized$(basename ${f%.fq.gz}.hdf5)"  # Define the output file path in the new directory

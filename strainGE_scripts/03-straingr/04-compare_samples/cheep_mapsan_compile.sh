#!/bin/bash
#SBATCH --job-name="mapsan-cheep-compile"
#SBATCH --nodes=1
...
#SBATCH --output=log/mapsan-cheep-compile-%j.o
#SBATCH --error=log/mapsan-cheep-compile-%j.e
#SBATCH --mail-type=ALL
#SBATCH --mail-user=maya.l.nadimpalli@emory.edu


#Set paths
COMPARE_DIR=/projects/mnadimlab/nmolson/data/straingr/straingr_cheep_mapsan
OUTPUT1=$COMPARE_DIR/11April_cheep_mapsan_sample_comparisons.tsv

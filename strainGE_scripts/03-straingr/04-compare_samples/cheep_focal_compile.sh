#!/bin/bash
#SBATCH --job-name="focal-cheep-compile"
#SBATCH --nodes=1
...
#SBATCH --output=log/focal-cheep-compile-%j.o
#SBATCH --error=log/focal-cheep-compile-%j.e
#SBATCH --mail-type=ALL
#SBATCH --mail-user=maya.l.nadimpalli@emory.edu


#Set paths
COMPARE_DIR=/projects/mnadimlab/nmolson/data/straingr/straingr_cheep_focal
OUTPUT1=$COMPARE_DIR/12April_cheep_focal_sample_comparisons.tsv

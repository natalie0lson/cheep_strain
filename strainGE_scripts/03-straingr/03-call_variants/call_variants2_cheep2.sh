...
#SBATCH --output=cheep2_var-%j.o
#SBATCH --error=cheep2_var-%j.e
...
BAM_DIR="/projects/mnadimlab/nmolson/data/straingr/cheep_align2"
REFERENCE="/projects/mnadimlab/nmolson/data/straingr/refs_concat4.fasta"
OUTPUT_DIR="/projects/mnadimlab/nmolson/data/straingr/call_var2/cheep"

...
#SBATCH --output=atl_var-%j.o
#SBATCH --error=atl_var-%j.e
...
BAM_DIR="/projects/mnadimlab/nmolson/data/straingr/atl_cheep_aligned/atl"
REFERENCE="/projects/mnadimlab/nmolson/data/straingr/refs_concat_atl.fasta"
OUTPUT_DIR="/projects/mnadimlab/nmolson/data/straingr/atl_cheep_var/atl"

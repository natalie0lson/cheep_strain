#!/bin/bash
#SBATCH --job-name="straingr_align_cheep"
#SBATCH --nodes=1
...
#SBATCH --output=straingr_align_cheep-%j.o
#SBATCH --error=straingr_align_cheep-%j.e
...
OUTPUT_DIR="/projects/mnadimlab/nmolson/data/straingr/cheep_align2"

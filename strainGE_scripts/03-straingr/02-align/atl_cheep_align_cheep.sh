#!/bin/bash
#SBATCH --job-name="atl_align_cheep"
#SBATCH --nodes=1
...
#SBATCH --output=atl_align_cheep-%j.o
#SBATCH --error=atl_align_cheep-%j.e
...
OUTPUT_DIR="/projects/mnadimlab/nmolson/data/straingr/atl_cheep_aligned/cheep"

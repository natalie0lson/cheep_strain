...
ST155 <- read.csv("Data/13C1079T_2024-10-29.csv")
ST10 <- read.csv("Data/NCTC9087_2024-10-29.csv")
ST117 <- read.csv("Data/APEC_2024-10-29.csv")
ST540 <- read.csv("Data/ST540_2024-10-29.csv")
...
all_strains <- rbind(ST155, ST10, ST117, ST540)
head(all_strains)
nrow(all_strains)
...
all_540 <- subset(all_ids, all_ids$strain=="ST540")
...
matrix_540$threshold[is.na(matrix_540$threshold)] <- 0
